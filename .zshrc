...
alias yta-listmp3="yt-dlp --ignore-errors --format bestaudio --extract-audio --audio-format mp3 --audio-quality 160K --output "%(title)s.%(ext)s" --yes-playlist "
...
# 
export PATH="$PATH:/home/spikedev/rust_modules/bin"
